...
public class PseIntParser extends Parser {
	...
	public static class InicioContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PseIntListener ) ((PseIntListener)listener).enterInicio(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PseIntListener ) ((PseIntListener)listener).exitInicio(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PseIntVisitor ) return ((PseIntVisitor<? extends T>)visitor).visitInicio(this);
